...
avformat_read_raw_packet_times(a0: string): Promise<string>;
/**
...
avformat_read_raw_packet_times_sync(a0: string): string | Promise<string>;
/**
 * Allocate the stream private data and write the stream header to
 * an output media file.
 *
 ...
 * will be fully resolved.
 */
ff_reader_dev_waiting_sync(): boolean;
/**
 * Metafunction to initialize an encoder with all the bells and whistles.
 * Returns [AVCodec, AVCodecContext, AVFrame, AVPacket, frame_size]
 * @param name  libav name of the codec
 ...
 * @param frame  Frame to copy in
 */
ff_copyin_frame_sync(framePtr: number, frame: Frame): void;
/**
 * Copy out a packet.
 * @param pkt  AVPacket
 */
 ...
 * @param packet  Packet to copy in.
 */
ff_copyin_packet_sync(pktPtr: number, packet: Packet): void;
/**
 * Allocate and copy in a 32-bit int list.
 * @param list  List of numbers to copy in
 */
